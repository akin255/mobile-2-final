...
public class location_type_1 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    public static final String API_KEY="AIzaSyCdW538zWQlnggL9x9Tt7QGmOq_lh877KQ";
    public static final String VIDEO_ID="WZeYrndNjY8";
    @Override
