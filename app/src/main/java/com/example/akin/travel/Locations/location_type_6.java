...
public class location_type_6 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    public static final String API_KEY="AIzaSyA4ZkHfcDQJYN6n7NBUJ60HeKfZGG8G7y8";
    public static final String VIDEO_ID="yZXrQ2Q1fuA";
    @Override
