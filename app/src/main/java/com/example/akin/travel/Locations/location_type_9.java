...
public class location_type_9 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    public static final String API_KEY="AIzaSyA4ZkHfcDQJYN6n7NBUJ60HeKfZGG8G7y8";
    public static final String VIDEO_ID="xh9fz0IrFlA";
    @Override
